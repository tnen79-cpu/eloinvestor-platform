...
export function EmptyState({ lang, country }: { lang: string; country: string }) {
  ...
  return (
    <div className="rounded-[2rem] border border-dashed border-slate-300 bg-white p-12 text-center shadow-sm">
      <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-blue-50 text-blue-700"><SearchX size={28} /></div>
      ...
      <Link href={`/${country}/${lang}/add-project`} className="mt-7 inline-flex rounded-2xl bg-blue-700 px-6 py-4 font-black text-white shadow-lg shadow-blue-900/10">
