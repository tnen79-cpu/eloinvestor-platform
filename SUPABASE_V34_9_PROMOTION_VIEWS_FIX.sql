-- V34.9 Promotion views fix
-- مهم: شغّل هذا الملف بعد V34.8 إذا كانت النقرات والتواصل تعمل لكن المشاهدات لا تزيد.
-- هذا الملف يعيد إنشاء دالة عدّادات الترويج بشكل أكثر تسامحًا مع status و ends_at.
